...
function Products(props) {
    ...
    useEffect(() => {
        async function getProductFashionWithImages() {
            ...
            setProductFashion(updatedProductFashion);
        }

        getProductFashionWithImages();
    }, []);
        ...
        <div className='products'>
            <div className="container">
                <div className="products_start">
                    <div className="products_fashion">
                        <div className="blocks">
                            <div className="block"></div>
                            <p className="block-text">Now in Fashion</p>
                        </div>
                        <div className="products_fashion-start">
                            <Slider {...settings}>
                                {productFashion.map(item => (
                    ...
                    <div className="products_sale">
                        <div className="blocks">
                            <div className="block"></div>
                            <p className="block-text">Sale</p>
                        </div>
                        <div className="products_sale-start">
                            <Slider {...settings}>
                                {productFashion.map(item => (
                                    <div className="home_product-sale-block" key={item.id}>
                                        <div className="homeAll_products-content-block">
                    ...
                    <div className="products_justforyou">
                        <div className="blocks">
                            <div className="block"></div>
                            <p className="block-text">Just For You</p>
                        </div>
                        <div className="products_justforyou-start">
                            <Slider {...settings}>
                                {productFashion.map(item => (
                                    <div className="home_product-sale-block" key={item.id}>
                                        <div className="homeAll_products-content-block">
