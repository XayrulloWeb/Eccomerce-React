...
import appsstore from "../../assets/Icons/AppStore.png"
import googleplay from "../../assets/Icons/GooglePlay.png"
import code from "../../assets/Icons/QrCode.png"
                ...
                <div className="container">
                    <div className="footer_start">
                        ...
                        <div className="footer-section">
                            ...
                            <p><a href="tel:+8801588889999">+88015-88888-9999</a></p>
                        </div>
                        <div className="footer-section">
                            <h4>Account</h4>
                            <ul>
                        ...
                        <div className="footer-section">
                            <h4>Download App</h4>
                            <p className="footer-section-p">Save $3 with App New User Only</p>
                            <div className="app-links-footer">
                                ...
                                <div className="app-links">
                                    ...
                                    <a href="#"><img src={appsstore} alt="App Store"/></a>
                                </div>
                            ...
                            <div className="social-links">
                                ...
                                <a href="#">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_865_1563)">
                                            <path
